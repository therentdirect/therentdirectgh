...
export default function FindMeAHomePage() {
  ...
  const [budgetFlexibility, setBudgetFlexibility] =
    useState("contact_first");
  const [moveUrgency, setMoveUrgency] =
    useState("within_30_days");
  const [nearbyAreasPreference, setNearbyAreasPreference] =
    useState("contact_first");
    ...
    try {
      const { data, error } = await supabase
        ...
        .insert({
          ...
          move_urgency: moveUrgency,
          nearby_areas_preference: nearbyAreasPreference,
    ...
    <main className="space-y-8 pb-16">
        ...
        <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-sm font-medium leading-7 text-neutral-300 md:text-base">
              ...
              options for 30 days, with a free 15-day extension if
              no suitable apartment is found.
            </p>
          </div>
      ...
      <section className="grid gap-5 md:grid-cols-3">
        ...
        <div className="rounded-[26px] border border-neutral-200 bg-white p-6">
          ...
          <p className="mt-2 text-sm leading-6 text-neutral-500">
            Pay the one-time GH₵450 fee securely through Hubtel.
          </p>
        </div>
        ...
        <div className="rounded-[26px] border border-neutral-200 bg-white p-6">
          ...
          <p className="mt-2 text-sm leading-6 text-neutral-500">
            Track your request for 30 days, plus a free 15-day extension if needed.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="mt-7 grid gap-5 md:grid-cols-2">
          ...
          <label className={labelClass}>
            ...
            <select
              ...
              onChange={(event) =>
                setBudgetFlexibility(event.target.value)
              }
            >
              <option value="strict">
                Strict budget — do not show options above it
              </option>
              <option value="up_to_10_percent">
                Show options up to 10% above my budget
              </option>
              <option value="up_to_20_percent">
                Show options up to 20% above my budget
              </option>
              <option value="contact_first">
                Contact me before showing higher-priced options
              </option>
            </select>

            <span className="mt-2 block text-xs font-medium leading-5 text-neutral-500">
              This tells our team what to do when suitable apartments
              cost more than your maximum budget.
            </span>
          </label>
          ...
          <label className={labelClass}>
            ...
            <select
              ...
              value={moveUrgency}
              onChange={(event) =>
                setMoveUrgency(event.target.value)
              }
            >
            ...
            <span className="mt-2 block text-xs font-medium leading-5 text-neutral-500">
              This helps RentDirect understand how urgently you need
              accommodation. It does not guarantee a specific completion date.
            </span>
          </label>

          <label className={`${labelClass} md:col-span-2`}>
            Nearby Areas Preference
            <select
              className={inputClass}
              value={nearbyAreasPreference}
              onChange={(event) =>
                setNearbyAreasPreference(event.target.value)
              }
            >
              <option value="selected_locations_only">
                Search only my selected locations
              </option>
              <option value="nearby_areas_allowed">
                You may also search suitable nearby areas
              </option>
              <option value="contact_first">
                Contact me before searching nearby areas
              </option>
            </select>

            <span className="mt-2 block text-xs font-medium leading-5 text-neutral-500">
              Nearby areas will only be considered according to the
              preference you select.
            </span>
          </label>
        </div>
        ...
        <div className="mt-9 rounded-[26px] border border-yellow-200 bg-yellow-50 p-5">
          ...
          <p className="mt-3 text-sm font-medium leading-7 text-neutral-700">
            ...
            your submitted requirements for 30 days after successful
            payment. If no suitable apartment is found within those
            30 days, your search will be extended for an additional
            15 days at no extra cost.
          </p>

          <p className="mt-3 text-sm font-medium leading-7 text-neutral-700">
            The one-time GH₵450 service fee covers the apartment
            search service, property discovery, transportation,
            communication, photos and videos, customer support and
            inspection coordination.
          </p>

          <div className="mt-4 grid gap-2 text-sm font-bold text-neutral-800 sm:grid-cols-3">
            <div className="rounded-2xl bg-white p-3">
              No agent commission
            </div>

            <div className="rounded-2xl bg-white p-3">
              No RentDirect viewing fee
            </div>

            <div className="rounded-2xl bg-white p-3">
              No RentDirect inspection fee
            </div>
          </div>

          <p className="mt-4 text-sm font-medium leading-7 text-neutral-700">
            RentDirect cannot guarantee that a suitable apartment
            will be available because prices, landlord decisions and
            rental-market availability are outside our control. The
            service fee is generally non-refundable after the search
            has started because it covers work and expenses already
            incurred.
          </p>

          <p className="mt-3 text-sm font-medium leading-7 text-neutral-700">
            If no suitable apartment is found after the complete
            45-day search period, you may close the request, adjust
            your requirements, or renew the search for another
            30 days at the discounted renewal fee.
          </p>

          <p className="mt-3 text-sm font-medium leading-7 text-neutral-700">
            The GH₵450 fee is not apartment rent, rent advance,
            security deposit or any landlord-required payment.
          </p>
